...
export default function CourseCurriculum({ sections, onLessonSelect }) {
            ...
            {expandedSections[sectionIndex] && (
              <div className="pb-4 space-y-3">
                {section.lessons?.map((lesson, lessonIndex) => (
                  <div
                    key={lessonIndex}
                    className="flex justify-between items-center pl-4 cursor-pointer hover:text-blue-600"
                    onClick={() => onLessonSelect?.(lesson, section.title)}
                  >
